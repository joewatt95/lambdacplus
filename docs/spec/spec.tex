...
\info{
Note that \texttt{(let x := E in E')} expressions are not considered to be in head 
...
\info{
  This concept is alpha and beta equivalence is important because we will
  need to compare expressions for equivalence later when we describe our
...
\item \textbf{Check} \\
  ...
  \info{
    To compare 2 expressions that are in head normal form for equality,
