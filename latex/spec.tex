...
\section{Syntax}
\todo[inline]{TODO: Document the lightweight syntactic sugar in the spirit of Lean for writing proofs
and give some sample proofs}
...
As syntactic sugar, users can write \verb|A \/ B| instead.
...
in $E_2$. \verb|inl| and \verb|inr| are used to indicate which case we are
considering
