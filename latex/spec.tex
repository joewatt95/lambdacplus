...
and \verb|axiom| statements. This \verb|und| value is used for the
...
\begin{definition} [Bidrectional typechecking]
  ...
  \item \textbf{Var} \\
    ...
    If there are multiple occurences of the variable $x$ in $\Gamma$, as is the case
    when there is variable shadowing, we take the first occurence of $x$ in the
    list that is $\Gamma$.
